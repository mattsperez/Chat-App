...
const CustomActions = ({ wrapperStyle, iconTextStyle, onSend, storage, userID }) => {
    ...
    //unique ref string when an image is uploaded and sent in messages
    ...
    //allow user to send a picture taken from their camera
    ...
    //generates a unique ref string for the images uploaded and sent
